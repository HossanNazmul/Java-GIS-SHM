...
//-------------------------------------------------------------------------------
//Name: 	   Main Graphical user interface 
//Author:      Nazmul
//
//Created:     26/02/2015
//Modified:	   26/03/2015
		...
		btnInsertObservation.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				try 
				{
					...
					{
						SelectNode2XML.importXML(nameOfService,sosServerURL, filePath );
					}
...
////						System.out.println(userPassword);
						...
						SelectNode2JDBC.DBInsertion(filePath, nameOfService, sosServerURL);
					}
