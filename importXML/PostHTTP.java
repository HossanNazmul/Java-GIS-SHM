...
public class PostHTTP {
     ...
     *
     */
    public static void post(String url, String myFileName) throws Exception {
        ...
        //String strURL = "http://fbinter.stadt-berlin.de/fb/wfs/geometry/senstadt/re_bezirke";
        String strURL = url;
       
        //strURL = args[0];
          
        // Get file to be posted
        String strXMLFilename = myFileName;

        //String strXMLFilename = "F:/3rd Semester/GIS Project/HTTP POST/PostXMLRequest/resources/WFS_GetFeature.XML";
